...
(cl:in-package learing_communication-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learing_communication-msg:<person> is deprecated: use learing_communication-msg:person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_communication-msg:name-val is deprecated.  Use learing_communication-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_communication-msg:sex-val is deprecated.  Use learing_communication-msg:sex instead.")
  (sex m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_communication-msg:age-val is deprecated.  Use learing_communication-msg:age instead.")
  (age m))
