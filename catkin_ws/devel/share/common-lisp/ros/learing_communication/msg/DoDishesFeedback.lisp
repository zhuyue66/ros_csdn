...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learing_communication-msg:<DoDishesFeedback> is deprecated: use learing_communication-msg:DoDishesFeedback instead.")))

(cl:ensure-generic-function 'percent_complete-val :lambda-list '(m))
(cl:defmethod percent_complete-val ((m <DoDishesFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_communication-msg:percent_complete-val is deprecated.  Use learing_communication-msg:percent_complete instead.")
  (percent_complete m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DoDishesFeedback>)))
  ...
  "learing_communication/DoDishesFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DoDishesFeedback)))
  "Returns string type for a message object of type 'DoDishesFeedback"
  "learing_communication/DoDishesFeedback")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DoDishesFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# 定义反馈的百分比~%float32 percent_complete~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DoDishesFeedback)))
  "Returns full string definition for message of type 'DoDishesFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# 定义反馈的百分比~%float32 percent_complete~%~%~%~%~%"))
